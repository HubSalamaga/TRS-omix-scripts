...
3. Creates a new path in the folder where the script is located, named ${\color{red}specified \space folder \space name}$$. This path will contain all files generated during analysis, dynamically changing to include information about the experiment.
